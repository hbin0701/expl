...
from utils.tokenizer_utils import get_tokenized_dataset, get_custom_tokenized_dataset
from trainers import GenerationTrainer, CustomSeq2SeqTrainer
...
def main():
    ...
    elif model_args.model_mode == "generation": # Currently for gpt2.
        torch_dtype = torch.float16 if model_args.torch_dtype_fp16 else None
    ...
    if model_args.model_mode == "mc":
        ...
        training_args.generation_max_length = 50 # added
